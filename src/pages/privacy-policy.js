        ...
        >
          <Row>
            ...
            >
              ...
              <p>ARC ("us", "we", or "our") operates the https://alan-campos.com
              ...
              <p>We use your data to provide and improve the Service. By using
              ...
              <p>We may also collect information how the Service is accessed and
              ...
              <p>Cookies are files with small amount of data which may include
              ...
              <ul>
                <li><strong>Session Cookies.</strong> We use Session Cookies to
                  operate our Service.
                </li>
                <li><strong>Preference Cookies.</strong> We use Preference
                  Cookies to remember your preferences and various settings.
                </li>
                <li><strong>Security Cookies.</strong> We use Security Cookies
              ...
              <p>ARC uses the collected data for various purposes:</p>
              <ul>
                ...
                <li>To provide analysis or valuable information so that we can
                  improve the Service
                </li>
              ...
              <p>Your information, including Personal Data, may be transferred
              ...
              <p>If you are located outside United States and choose to provide
                ...
                there.</p>
              <p>Your consent to this Privacy Policy followed by your submission
                of such information represents your agreement to that
                transfer.</p>
              <p>ARC will take all steps reasonably necessary to ensure that
              ...
              <p>ARC may disclose your Personal Data in the good faith belief
                that such action is necessary to:</p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of ARC</li>
              ...
              <h3>Analytics</h3>
              <p>We may use third-party Service Providers to monitor and analyze
                the use of our Service.</p>
              <ul>
                <li>
                  ...
                  <p>You can opt-out of having made your activity on the Service
                    ...
                    activity.</p>                <p>For more information on the
